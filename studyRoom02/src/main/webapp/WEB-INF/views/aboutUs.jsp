...
<jsp:include page="./includes/header_.jsp" />
	...
	<div class="news">
		...
		<div class="d-flex justify-content-center text-warning mb-5">
			...
			<div class="row"> <!-- 본문 시작 -->
				<span class="text-danger ml-3">* 사이트 내 모든 조회는 비회원도 가능하지만, 등록은 회원만 가능합니다.</span>
				
				<div class="mt-3 col-md-12">
					<h2 class="text-warning">좌석 등록하기</h2>
				...
				<div class="mt-5 col-md-12">
					<h2 class="text-warning">좌석 연장하기</h2>
				...
				<div class="mt-5 col-md-12">
					<h2 class="text-warning">좌석 변경하기</h2>
				...
				<div class="mt-5 col-md-12">
					<h2 class="text-warning">요금 안내</h2>
					<h3>- 좌석</h3>
